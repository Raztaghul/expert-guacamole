// URL: https://observablehq.com/d/078e6557eb434a15
// Title: Faraya: Mapping Proc_Persons
// Author: Paul.G (@paulgg-code)
// Version: 267
// Runtime version: 1

const m0 = {
  id: "078e6557eb434a15@267",
  variables: [
    {
      inputs: ["md"],
      value: (function(md){return(
md`# Faraya: Mapping Proc_Persons`
)})
    },
    {
      name: "viewof order",
      ...
      value: (function(d3,html,Promises)
{
  ...
  return form;
    ...
    {
      name: "chart",
      inputs: ["d3","DOM","width","height","graph","margin","y","color","arc","step","viewof order","invalidation"],
      value: (function(d3,DOM,width,height,graph,margin,y,color,arc,step,$0,invalidation)
{
...
function arc(d) {
  ...
  return `M${margin.left},${y1}A${r},${r} 0,0,${y1 < y2 ? 1 : 0} ${margin.left},${y2}`;
    ...
    {
      name: "y",
      inputs: ["d3","graph","margin","height"],
      value: (function(d3,graph,margin,height){return(
...
14
    ...
    },
    {
      name: "color",
      inputs: ["d3","graph"],
      value: (function(d3,graph){return(
...
d3.json("https://raw.githubusercontent.com/PaulGG-Code/map/main/Proc_Persons_ISO17025.json")
)})
    },
    {
      name: "d3",
